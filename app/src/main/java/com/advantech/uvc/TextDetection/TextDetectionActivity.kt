...
class TextDetectionActivity : AppCompatActivity(), SurfaceHolder.Callback,
    ...
    private var iCameraHelpCallBack: ICameraHelper.StateCallback =
        object : ICameraHelper.StateCallback {
            ...
            override fun onDeviceOpen(device: UsbDevice?, isFirstOpen: Boolean) {
                ...
                Toast.makeText(this@TextDetectionActivity, "onDeviceOpen", Toast.LENGTH_SHORT)
                    .show()
            ...
            override fun onCameraOpen(device: UsbDevice?) {
                ...
                if (mCameraHelper != null) {
                    ...
                    if (size != null) {
                        ...
                        runOnUiThread { textDetectionConfig() }
                    }
...
var isFrameStart:Boolean=false
    private fun textDetectionConfig() {
        ...
        if (mCameraHelper != null) {
            ...
            mCameraHelper?.setFrameCallback({ frame ->
                if (!isFrameStart) {
                    ...
                    val drawableId: Int = R.drawable.i
                    val drawable = ContextCompat.getDrawable(this, drawableId)
                    val bitmap: Bitmap = drawableToBitmap(drawable)!!
                    isFrameStart=true
                val newvisionText = NewVersionGCVTextApi(this)
                newvisionText.detectText(this,imageView, bitmap)
//                val barcode= BarcodeDecoder(this)
//                barcode.processImage(bitmap,imageView)
//                val googleTextVision= GoogleTextVision(this)
//                googleTextVision.callCloudVision(imageView,bitmap)
//                val firebasecloudML=FireabaseCloudMlOcr(this)
//                firebasecloudML.detectText2(bitmap,imageView)
        ...
        {
            Toast.makeText(this@TextDetectionActivity,"Camera is now closed",Toast.LENGTH_SHORT).show()
        }
    }
    ...
    override fun onSurfaceTextureUpdated(surface: SurfaceTexture) {
        if (mCameraHelper != null) {
            //Log.d("---", "onSurfaceTextureUpdated: camera open =${mCameraHelper!!.isCameraOpened}")
    ...
    override fun surfaceCreated(holder: SurfaceHolder) {
        Toast.makeText(this@TextDetectionActivity, "surfaceCreated", Toast.LENGTH_SHORT)
            .show()
        if (mCameraHelper != null) {
    ...
    override fun surfaceChanged(holder: SurfaceHolder, format: Int, width: Int, height: Int) {
        Toast.makeText(this@TextDetectionActivity, "surfaceChanged", Toast.LENGTH_SHORT)
            .show()
