...
import com.advantech.uvc.TextDetection.FireabaseCloudMlOcr
import com.advantech.uvc.TextDetection.GoogleTextVision
...
//                tensflowObjectDetect(bitmap,voiceStatus)
    ...
    private fun tensflowObjectDetect(bitmap: Bitmap, voiceStatus: Boolean){
            ...
            if (fl.toDouble() == 0.5) {
                ...
                synchronized(this) { ->
                    if (!voiceStatus) {
                        ...
                        textToSpeech.speak(labels[classes.get(index).toInt()], TextToSpeech.QUEUE_FLUSH, params)
                    }
                }
