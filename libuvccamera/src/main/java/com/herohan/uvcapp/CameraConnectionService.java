...
class CameraConnectionService {
    ...
    private int mReceiverNotExported;
    ...
    public ICameraConnection newConnection(int receiverNotExported) {
       mReceiverNotExported= receiverNotExported;
        return new CameraConnection(mReceiverNotExported);
    }
    ...
    private final class CameraConnection implements ICameraConnection {
        ...
        CameraConnection(int mReceiverNotExported) {
